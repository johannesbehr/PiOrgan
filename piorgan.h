...
class PiOrgan{
    public:
        ...
        std::vector<std::string> getMidiFiles();
        ...
        void setMusicKeyPressed(void (*fnk)());
        ...
        void setTickHandler(void (*fnk)(int,int));
    ...
    private:
        ...
        void (*tick_)(int, int) = NULL;
        void (*musicKeyPressed_)() = NULL;
